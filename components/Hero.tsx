...
export default function Hero() {
  return (
    <div
        id="home"
        className="p-4 flex flex-col md:flex-row gap-8 items-center md:items-start"
    >
      <div className="rounded-md p-8 flex-1 content-evenly text-2xl">
          ...
          <h1 className="text-5xl md:text-6xl font-black tracking-tighter mb-6 opacity-90">
           SUBTRACTING
          </h1>
